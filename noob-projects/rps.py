...
while is_playing:
    ...
    if (
        (command == "r" and possibilities == "scissors")
        or (command == "p" and possibilities == "rock")
        or (command == "s" and possibilities == "paper")
    ):
        player_wins += 1
        print("You won!")
    elif (
        (command == "r" and possibilities == "paper")
        or (command == "p" and possibilities == "scissors")
        or (command == "s" and possibilities == "rock")
    ):
        computer_wins += 1
        print("You lose!")
    elif (
        (command == "r" and possibilities == "rock")
        or (command == "p" and possibilities == "paper")
        or (command == "s" and possibilities == "scissors")
    ):
        draws += 1
        print("Draw!")
    else:
