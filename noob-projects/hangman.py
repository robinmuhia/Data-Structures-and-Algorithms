...
while is_playing:
    try:
        ...
        generated_word_letters = set(
            x[0].lower() for x in generated_word
        )  # tabulates letters in the aforementioned word
        ...
        while True:
            correct_guessed_word = (
                letter if letter in guessed_letters else "_" for letter in generated_word
            )
